...
def get_model_instance_segmentation(num_classes, args):
    ...
    elif args.backbone == 'resnet101-custom' or args.backbone == 'inception_resnet_v2':
        # Custom implementation with manually constructed backbone
        print(f"Using custom {args.backbone} backbone with optimized parameters")
        
        # Create a backbone with FPN
        backbone = resnet_fpn_backbone('resnet101', pretrained=args.pretrained)
        
        # Create the Faster R-CNN model with the backbone
        model = FasterRCNN(
            backbone, 
    ...
    # Modify ROI parameters with reasonable detection limits
