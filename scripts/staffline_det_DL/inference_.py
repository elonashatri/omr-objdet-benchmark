...
def process_directory(model, input_dir, output_dir, device, post_process=True, max_size=1024, batch_size=1):
    """
...
def run_inference(model_path, input_path, output_dir, batch_mode=False, 
                 gpu_id=0, post_process=True, max_size=1024, subset=None):
    """
