...
if __name__ == "__main__":
    ...
    detected_elements_path = "/homes/es314/omr-objdet-benchmark/scripts/encoding/results/faster_rcnn_results/object_detections/Abismo_de_Rosas__Canhoto_Amrico_Jacomino-002_detections.json"  # Replace with your detections
