...
class Stem:
    """Class representing a stem in musical notation."""
    def __init__(self, class_id, class_name, confidence, bbox):
        ...
        self.staff_system = None  # Will be assigned later
        self.connected_note = None  # Will be connected to a note later
        
    def __str__(self):
        return f"Stem at ({self.x:.1f}, {self.y:.1f})"
