...
# python complete_pipeline.py --image_dir /homes/es314/1-OMR_EVAL/GT/images \
...
#     --output_dir /homes/es314/omr-objdet-benchmark/scripts/encoding/clean_full_pipeline/complete_pipeline_1/results \
#     --conf 0.3 \
#     --iou 0.25 \
#     --high_conf 0.5 \
#     --overlap 0.5 \
